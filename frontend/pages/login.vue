<template>
  <div class="max-w-md mx-auto mt-20">
    <div class="bg-white rounded-xl shadow-md p-8">
      ...
      <div class="space-y-3">
        <button
          class="w-full py-2 border border-gray-300 rounded-lg hover:bg-gray-50 flex items-center justify-center gap-2 transition-colors"
          @click="mockOAuth('google')"
        >
      ...
      <p class="mt-6 text-center text-sm text-gray-500">
        ...
        <NuxtLink to="/register" class="text-indigo-600 hover:text-indigo-700 font-medium">Register</NuxtLink>
      </p>
    </div>
  </div>
</template>
...
const mockOAuth = (provider: string) => {
  errorMsg.value = `${provider} login is not implemented yet (mock design only)`
}
</script>
